...
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.beam.vendor.guava.v20_0.com.google.common.collect.ImmutableList;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.config.CalciteConnectionConfig;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.jdbc.CalciteSchema;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.plan.Contexts;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.plan.ConventionTraitDef;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.plan.RelOptPlanner.CannotPlanException;
...
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.prepare.CalciteCatalogReader;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.rel.RelRoot;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.schema.SchemaPlus;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.SqlNode;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.SqlOperatorTable;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.fun.SqlStdOperatorTable;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.parser.SqlParseException;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.parser.SqlParser;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.parser.SqlParserImplFactory;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.sql.util.ChainedSqlOperatorTable;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.tools.FrameworkConfig;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.tools.Frameworks;
import org.apache.beam.vendor.calcite.v1_18_0.org.apache.calcite.tools.Planner;
