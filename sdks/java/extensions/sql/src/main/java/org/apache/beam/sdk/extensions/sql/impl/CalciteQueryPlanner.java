...
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.plan.ConventionTraitDef;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.plan.RelOptCost;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.plan.RelOptPlanner.CannotPlanException;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.plan.RelOptUtil;
...
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.prepare.CalciteCatalogReader;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.RelNode;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.RelRoot;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.BuiltInMetadata;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.ChainedRelMetadataProvider;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.JaninoRelMetadataProvider;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.MetadataDef;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.MetadataHandler;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.ReflectiveRelMetadataProvider;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.rel.metadata.RelMetadataProvider;
...
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.SqlNode;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.SqlOperatorTable;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.fun.SqlStdOperatorTable;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.parser.SqlParseException;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.parser.SqlParser;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.parser.SqlParserImplFactory;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.sql.util.ChainedSqlOperatorTable;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.tools.FrameworkConfig;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.tools.Frameworks;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.tools.Planner;
import org.apache.beam.vendor.calcite.v1_19_0.org.apache.calcite.tools.RelConversionException;
